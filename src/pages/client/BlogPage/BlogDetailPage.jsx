      ...
      <Row>
        <Col span={16}>
          ...
          <Space size="large" style={{ marginTop: "10px" }}>
            <span>
              Ngày đăng: {moment(detailBlog.createdAt).format("DD/MM//YYYY")}
            </span>
            <span>
              <CommentOutlined /> {detailBlog?.comment?.length || 0} bình luận
            </span>
          </Space>
                ...
                >
                  ...
                  <div className="blog__content--info">
                    <span style={{ fontSize: "0.9em" }}>
                      {moment(blog.createdAt).format("MM/DD/YYYY HH:MM")}
                    </span>
                  </div>
                </div>
              </div>
        ...
        <Col span={16}>
          <Comments currentUserId={user?.id} idPost={idPost} />
        </Col>
      </Row>
    </div>
  );
